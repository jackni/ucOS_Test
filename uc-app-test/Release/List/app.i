...
OS_STK  AppTaskStartStk[100];
OS_STK AppTask1Stk[100];
OS_STK AppTask2Stk[100];
OS_STK AppTask3Stk[100];
OS_STK KeyScanTaskStk[100];
OS_STK DispTaskStr[100];
...
void  main (void)
{
  ...
  OSTaskStkSize = 100;
  OSTaskStkSizeHard = 50;
  OSTaskCreate(AppTaskStart,(void*)0,&AppTaskStartStk[OSTaskStkSize-1],0);
  ...
  OSTaskStkSize = 100;
  OSTaskStkSizeHard = 50;
  OSTaskCreate(KeyScanTask,(void*)0,(OS_STK*)&KeyScanTaskStk[OSTaskStkSize-1],14);
  ...
  OSTaskStkSize = 100;
  OSTaskStkSizeHard = 50;
  OSTaskCreate(DispTask,(void*)0,(OS_STK*)&DispTaskStr[OSTaskStkSize-1],4);
...
void DispTask(void *p_arg)
{
   ...
   LCD_WriteDoubleCommand0(0x0A,0x00,0x00);
   LCD_WriteDoubleCommand0(0x21,159,127);
   for(i=0;i<160;i++)
     for(j=0;j<128;j++)
     {
          LCD_WriteDoubleCommand0(0x22,100,0x00);
     }
     LCD_WriteDoubleCommand0(0x0A,0x00,0x00);
     DispChar(24,72,21,1);
