...
void KeyBoard_Init(void)
{
  ...
  KeyScanState = 1;
  PORTD&=0x7f;
  (*(volatile unsigned char *)0xfffe)=0x00;
  keypressed = 0;
  PORTD|=0x80;
}
...
INT8U  KeyDecode (void)
{
  ...
  msk=0x3f;
  PORTD&=0x7f;
  (*(volatile unsigned char *)0xfffe)=msk&0xfe;
  if(!((*(volatile unsigned char *)0xfffc)&0x01))code=1; 
  if(!((*(volatile unsigned char *)0xfffc)&0x02))code=2; 
  if(!((*(volatile unsigned char *)0xfffc)&0x04))code=3; 
  (*(volatile unsigned char *)0xfffe)=msk&0xfd;
  if(!((*(volatile unsigned char *)0xfffc)&0x01))code=4; 
  if(!((*(volatile unsigned char *)0xfffc)&0x02))code=5; 
  if(!((*(volatile unsigned char *)0xfffc)&0x04))code=6; 
  (*(volatile unsigned char *)0xfffe)=msk&0xfb;
  if(!((*(volatile unsigned char *)0xfffc)&0x01))code=7; 
  if(!((*(volatile unsigned char *)0xfffc)&0x02))code=8; 
  if(!((*(volatile unsigned char *)0xfffc)&0x04))code=9; 
  if(!((*(volatile unsigned char *)0xfffc)&0x08))code=10;
  (*(volatile unsigned char *)0xfffe)=msk&0xf7;
  if(!((*(volatile unsigned char *)0xfffc)&0x01))code=11; 
  if(!((*(volatile unsigned char *)0xfffc)&0x02))code=12; 
  if(!((*(volatile unsigned char *)0xfffc)&0x04))code=13; 
  if(!((*(volatile unsigned char *)0xfffc)&0x08))code=14; 
  (*(volatile unsigned char *)0xfffe)=msk&0xef;
  if(!((*(volatile unsigned char *)0xfffc)&0x01))code=15; 
  if(!((*(volatile unsigned char *)0xfffc)&0x02))code=16; 
  if(!((*(volatile unsigned char *)0xfffc)&0x04))code=17; 
  if(!((*(volatile unsigned char *)0xfffc)&0x08))code=18;
  (*(volatile unsigned char *)0xfffe)=msk&0xdf;
  if(!((*(volatile unsigned char *)0xfffc)&0x01))code=19; 
  if(!((*(volatile unsigned char *)0xfffc)&0x02))code=20; 
  if(!((*(volatile unsigned char *)0xfffc)&0x04))code=21; 
  (*(volatile unsigned char *)0xfffe)=0x00;
  PORTD|=0x80;
