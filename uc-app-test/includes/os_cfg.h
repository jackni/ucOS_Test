...
#define OS_CFG_H
                                       ...
                                       /* ----------------------- uC/OS-View ------------------------- */
#define OS_VIEW_MODULE             0   /* uC/OS-View module is present (1) or not present (0)          */
#define OS_TICK_STEP_EN            1   /* Enable tick stepping feature for uC/OS-View                  */


                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE     240   /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE    240   /* Statistics task stack size (# of OS_STK wide entries)        */
//#define OS_TASK_IDLE_STK_SIZE    240   /* Idle       task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE    100   /* Idle       task stack size (# of OS_STK wide entries)        */
...
#define OS_EVENT_NAME_SIZE        20   /* Determine the size of the name of a Sem, Mutex, Mbox or Q    */
...
#if     OS_VERSION >= 281              /* --------------------- TIMER MANAGEMENT --------------------- */
#define OS_TMR_EN                  0   /* Enable (1) or Disable (0) code generation for TIMERS         */
#define OS_TMR_CFG_MAX            10   /*     Maximum number of timers                                 */
#define OS_TMR_CFG_NAME_SIZE      16   /*     Determine the size of a timer name                       */
#define OS_TMR_CFG_WHEEL_SIZE     16   /*     Size of timer wheel (#Entries)                           */
#endif
